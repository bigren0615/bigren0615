Aspiring Game Developer | Full-Stack .NET & Frontend Developer | Unity 2D Enthusiast  

I love building interactive experiences, whether it’s **web applications** with ASP.NET/React or **mini RPG games** in Unity. Currently focusing on **real-time 2D action RPGs**, learning to make games that not only function well but also feel polished and visually appealing.
